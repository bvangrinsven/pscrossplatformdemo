...
namespace pscrossdemo.utils
{
    public static class Helpers
    {
        ...
        public static string GetPullAllSql(string SrcTableName, List<SchemaProp> srcProps, List<SchemaProp> destProps)
        {
            ...
            {
                if (srcProps.FindIndex(x => x.ColumnName == dstCol.ColumnName) > 0)
                {
